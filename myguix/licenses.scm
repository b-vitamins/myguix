...
(define-module (myguix licenses)
  #:export (nonfree artistic-1.0 cc-by-nd4.0 undistributable))
...
at URI, which may be a file:// URI pointing the package's tree."
  (license "Nonfree" uri
           (string-append
            "This a nonfree license.  Check the URI for details.  " comment)))

(define artistic-1.0
  (license "Artistic 1.0" "https://opensource.org/license/artistic-1-0/"

  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0zw3vsmd07yr27y5fz0m357hci00ah5impx5sz4jcnd18ldmaaf0"))))
    ...
    (package
      ...
      (source
       (origin
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "15lcf6bgxw7k846ijp0fqlcr6vj59v8s7hm16sikf0nd4xk0mdn5"))))
    ...
    (package
      ...
      (source
       (origin
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "042x2i390asl4w6vwbdd9qwxdzhhjdwgfipf4nkix899cixj0kr5"))))
      (build-system linux-module-build-system)
      (arguments
       (list
        #:make-flags

...
(define-public (myguix-extra-linux-options linux-or-version)
  "Return a list containing additional options that myguix sets by default
...
(define-public linux-xanmod-lts-source
  (make-linux-xanmod-source linux-xanmod-lts-version
                            ...
                            #:kernel-hash (base32
                                           "1sr58vsh39hdwk0z27lg14isqwn4g8m4r7a8z2rsyhkfwlmmd8mi")
                            #:xanmod-hash (base32
                                           "1k9p8ap2ghzn7qkbfj6rgd75wqp23xh32am1rf3k1j1j4j1k6gxx")))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0v590y795adw9yipnvhj0sgf9j99phdac01bdfydb2mmcbswck67"))))
...
;;; Note: To list firmwares sorted to update the description:
;;; d=$(guix build -L . realtek-firmware); find $d -regex '.*\(bin\|fw\).*' | sed "s,$d/lib/firmware/,," | sort
...
@item Realtek RTL8188FU firmware (rtlwifi/rtl8188fufw.bin)
...
@item Realtek RTL8192DU firmware (rtlwifi/rtl8192dufw.bin)
...
@item Realtek RTL8192FU firmware (rtlwifi/rtl8192fu.bin)
@item Realtek RTL8192SE/RTL8191SE firmware, version 4.816.2011 (rtlwifi/rtl8192sefw.bin)
@item Realtek RTL8710BU firmware (rtlwifi/rtl8710bufw_SMIC.bin)
@item Realtek RTL8192SU/RTL8712U firmware (rtlwifi/rtl8712u.bin)
@item Realtek RTL8723 firmware (rtlwifi/rtl8723fw.bin)
@item Realtek RTL8723 rev B firmware (rtlwifi/rtl8723fw_B.bin)
...
@item Realtek RTL8723B firmware (rtl_bt/rtl8723b_fw.bin)
...
@item Realtek RTL8723CS firmware (rtlwifi/rtl8723cs_xx_fw.bin)
@item Realtek RTL8723D firmware (rtlwifi/rtl8723d_fw.bin)
@item Realtek RTL8723DE firmware (rtlwifi/rtl8723defw.bin)
@item Realtek RTL8812AE non-WowLAN firmware (rtlwifi/rtl8812aefw.bin)
@item Realtek RTL8812AE WoWLAN firmware (rtlwifi/rtl8812aefw_wowlan.bin)
@item Realtek RTL8821AE non-WoWLAN firmware, version 29 (rtlwifi/rtl8821aefw_29.bin)
@item Realtek RTL8821AE WoWLAN firmware (rtlwifi/rtl8821aefw_wowlan.bin)
@item Realtek RTL8821AE non-WoWLAN firmware (rtlwifi/rtl8821aefw.bin)
@item Realtek RTL8821AE WoWLAN firmware (rtlwifi/rtl8821aefw_wowlan.bin)
@item Realtek RTL8822BE firmware (rtlwifi/rtl8822befw.bin)
@item Realtek RTW8703B WLAN firmware (rtw88/rtw8703b_fw.bin)
@item Realtek RTW8723D WLAN firmware (rtw88/rtw8723d_fw.bin)
@item Realtek RTW8812A WLAN firmware (rtw88/rtw8812a_fw.bin)
@item Realtek RTW8814A WLAN firmware (rtw88/rtw8814a_fw.bin)
@item Realtek RTW8821A WLAN firmware (rtw88/rtw8821a_fw.bin)
@item Realtek RTW8821C WLAN firmware (rtw88/rtw8821c_fw.bin)
@item Realtek RTW8822B WLAN firmware (rtw88/rtw8822b_fw.bin)
@item Realtek RTW8822C WLAN firmware (rtw88/rtw8822c_fw.bin)
@item Realtek RTW8851B WLAN firmware (rtw88/rtw8851b_fw.bin)
@item Realtek RTW8852A WLAN firmware (rtw88/rtw8852a_fw.bin)
@item Realtek RTW8852B WLAN firmware (rtw88/rtw8852b_fw.bin)
@item Realtek RTW8852BT WLAN firmware (rtw88/rtw8852bt_fw.bin)
@item Realtek RTW8852C WLAN firmware (rtw88/rtw8852c_fw.bin)
@item Realtek RTW8922A WLAN firmware (rtw88/rtw8852a_fw.bin)
...
@item Realtek RTL8125A firmware (rtl_nic/rtl8125a-3.fw)
@item Realtek RTL8125B firmware (rtl_nic/rtl8125b-1.fw)
@item Realtek RTL8125BP firmware (rtl_nic/rtl8125bp-2.fw)
@item Realtek RTL8125D firmware (rtl_nic/rtl8125d-1.fw)
@item Realtek RTL8125K firmware (rtl_nic/rtl8125k-1.fw)
@item Realtek RTL8126A firmware (rtl_nic/rtl8126a-2.fw)
@item Realtek RTL8127A firmware (rtl_nic/rtl8127a-1.fw)
@item Realtek RTL8153A firmware (rtl_nic/rtl8153a-2.fw)
@item Realtek RTL8153B firmware (rtl_nic/rtl8153b-2.fw)
@item Realtek RTL8153C firmware (rtl_nic/rtl8153c-1.fw)
@item Realtek RTL8156A firmware (rtl_nic/rtl8156a-2.fw)
@item Realtek RTL8156B firmware (rtl_nic/rtl8156b-2.fw)
...
@item Realtek RTL8168FP firmware (rtl_nic/rtl8168fp-3.fw)
...
@item Realtek RTL9151A firmware (rtl_nic/rtl9151a-1.fw)
...
@item Realtek RTL8761B Bluetooth firmware (rtl_bt/rtl8761b_fw.bin)
@item Realtek RTL8761BU Bluetooth firmware (rtl_bt/rtl8761bu_fw.bin)
@item Realtek RTL8761CU Bluetooth firmware (rtl_bt/rtl8761cu_fw.bin)
...
@item Realtek RTL8821CS Bluetooth firmware (rtl_bt/rtl8821cs_fw.bin)
...
@item Realtek RTL8822CS Bluetooth firmware (rtl_bt/rtl8822cs_fw.bin)
@item Realtek RTL8851BU Bluetooth firmware (rtl_bt/rtl8851bu_fw.bin)
@item Realtek RTL8852AU Bluetooth firmware (rtl_bt/rtl8852au_fw.bin)
@item Realtek RTL8852BU Bluetooth firmware (rtl_bt/rtl8852bu_fw.bin)
@item Realtek RTL8852CU Bluetooth firmware (rtl_bt/rtl8852cu_fw.bin)
@item Realtek RTL8922AU Bluetooth firmware (rtl_bt/rtl8922au_fw.bin)
@end itemize")
    (license (nonfree (string-append
                       "https://git.kernel.org/pub/scm/linux/kernel/git/firmware"
    ...
    (package
      ...
      (source
       (origin
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "0lklpn1gl202i49xjrd735pl595ynh2wpkdk1nlpcvxssi3qi0l7"))))
    ...
    (package
      ...
      (source
       (origin
         ...
         (file-name (git-file-name name version))
         (sha256
          (base32 "0dn1cmp8gn2g42q67lny15rrf092kw2rrb3gxc1qn07hbklj73bx"))))
      (build-system linux-module-build-system)
      (arguments
       (list
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0vv6f8k9p6kp9fgm1iwfagkdnbmvfi1049s8p1rfcd8xsd0ch46w"))))
    (build-system linux-module-build-system)
    (arguments
     '(#:tests? #f))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "05zmg7n67xbc49whjz3q43zq79jzcxxnb0m70p70jk6rlvin6gsk"))))
    (build-system copy-build-system)
    (arguments

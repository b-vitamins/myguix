...
;;;                                   (myguix-extra-linux-options linux-libre-lts)
...
(define-public linux-xanmod-lts-source
  (make-linux-xanmod-source linux-xanmod-lts-version
                            ...
                            #:kernel-hash (base32
                                           "1sr58vsh39hdwk0z27lg14isqwn4g8m4r7a8z2rsyhkfwlmmd8mi")
                            #:xanmod-hash (base32
                                           "1g7s9d2c6iycf1fpkrmcnz9n6kwpvx7k8nsgbmq8hgn8p537b6cd")))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1y90banizlmm9mj99f1h6sy22mv2y6c59q8ayd5xa3wkv2ramria"))))

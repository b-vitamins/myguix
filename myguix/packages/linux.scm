...
(define-public linux-xanmod-source
  (make-linux-xanmod-source linux-xanmod-version
                            ...
                            #:xanmod-hash (base32
                                           "1szi250nhj5j9km8q0z32hdf38kkl6kry5jh71dpc1ar0x1b26bd")))
...
(define-public linux-xanmod-lts-source
  (make-linux-xanmod-source linux-xanmod-lts-version
                            ...
                            #:xanmod-hash (base32
                                           "119jvwmxpjfpifg7mhqirjc1g1q769584hv2xc8wyg2iklhhs653")))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "0w0mclq20jcam6xl6jbil3n9vw74nqlvw0k7dkslnfck8y7v6b51"))))

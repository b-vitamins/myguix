    ...
    (source
     (origin
       ...
       (uri (string-append "https://updates.signal.org/desktop/apt/pool/s/"
                           ...
                           "_amd64.deb"))
       (sha256
        (base32 "1bbfr927l56hlh4aabgq6an6d57j0a9hkrc9mpi6mdbm8p5i76d2"))))
    (supported-systems '("x86_64-linux"))
    (build-system chromium-binary-build-system)
    (arguments
     (list
...
(define-public zoom
  (package
    ...
    (source
     (origin
       (method url-fetch)
       (uri (string-append "https://cdn.zoom.us/prod/" version
                           "/zoom_x86_64.tar.xz"))
    ...
    (description
     "The Zoom video conferencing and messaging client.  Zoom must be run via an

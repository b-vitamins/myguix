(define-module (myguix packages machine-learning)
  ...
  #:use-module ((gnu packages python-web)
                #:hide (python-huggingface-hub python-jose))
  #:use-module ((gnu packages python-xyz)
                #:hide (python-future python-types-pyyaml))
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1c7h1asl70qzk040jqc0lk8mfk9v2ysg366pljxfxhvg0qsmn8jv"))))
    (build-system pyproject-build-system)
    ...
    (native-inputs (list python-dm-tree python-flit-core python-pytest))
  ...
  (package
    ...
    (source
     (origin
       ...
       (file-name (git-file-name name version))
       (sha256
        (base32 "0bikvjiqgl659vjk1pw7hka95g55h5sgh3lmybwqfkzsqhfljjx2"))
       (modules '((guix build utils)))
       (snippet '(begin

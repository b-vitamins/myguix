    ...
    (package
      ...
      (arguments
       (list
        ...
        #:substitutable? #f
        #:wrapper-plan #~(let ((path (string-append "opt/google/"
                                                    #$appname "/")))
                           (map (lambda (file)
                     ...
                     (add-after 'install 'install-icons
                       (lambda _
                         (define (format-icon-size name)
                           (car (string-split (string-drop-right (string-drop
                                                                  name 13) 4)
                                              #\_)))
...
(define-public google-chrome-stable
  (make-google-chrome "stable" "131.0.6778.108"
                      "0b8a3dmn7n4kyjzyirxcy6xihnasmp3rcy2ly4zh7vp7r5l6lkqd"))

(define-public google-chrome-beta
  (make-google-chrome "beta" "130.0.6723.19"
                      "1mdadl83vczlbfd194l0lr7bkjfry5q1cz3sflwsahinaw1bpc3q"))

(define-public google-chrome-unstable
  (make-google-chrome "unstable" "131.0.6738.0"
                      "1ssb7sl7d4j40c4br6dhmm876f5iwdnvh3lf5jvmk5g56wbsh21p"))

    ...
    (source
     (origin
       ...
       (uri (string-append
             ...
             (string-map (lambda (x)
                           (if (char=? x #\.) #\- x)) version) "/icu4c-"
             (string-map (lambda (x)
                           (if (char=? x #\.) #\_ x)) version) "-src.tgz"))
       (sha256
  ...
  (package
    ...
    (source
     (origin
       ...
       (sha256
        (base32 "1dfr3z4qmf855ikvc7b09xhimn2sf48hl140dny2lqlmlcibdnnc"))))
    ...
    (source
     (origin
       ...
       (uri (string-append "https://archive.mozilla.org/pub/firefox/releases/"
             version "/source/firefox-" version ".source.tar.xz"))
       (sha256
        (base32 "0wy0fn0pavlhlkdybr59hhbn5ng0zn56mxa7gsknf8f2whiyipwx"))))
    (arguments

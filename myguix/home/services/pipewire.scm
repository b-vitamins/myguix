(define-module (myguix home services pipewire)
...
;; Borrowed from David Wilson (https://github.com/daviwil/dotfiles/blob/master/daviwil/home-services/pipewire.scm)
...
(define (home-pipewire-shepherd-service config)
  (list
   ...
   (shepherd-service (requirement '(dbus))
                     (provision '(pipewire))
   ...
   (shepherd-service (requirement '(pipewire))
...
(define (home-pipewire-xdg-configuration-service config)
  `(("alsa/asoundrc" ,(mixed-text-file "asoundrc"
                                       #~(string-append "<"
                                                        #$(file-append
                                                           pipewire
